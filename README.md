...
[![License: CC0-1.0](https://img.shields.io/badge/License-CC0_1.0-lightgrey.svg)](https://github.com/dendronhq/awesome-dendron/blob/main/LICENSE) ⭐ 245 | 🐛 3 | 📅 2022-10-22
[![lint](https://github.com/dendronhq/awesome-dendron/actions/workflows/lint.yaml/badge.svg)](https://github.com/dendronhq/awesome-dendron/actions/workflows/lint.yaml) ⭐ 245 | 🐛 3 | 📅 2022-10-22
...
* [TLDR](https://tldr.dendron.so/) - A Dendron vault of the [tldr-pages project](https://tldr.sh/): a collection of community-maintained help pages for command-line tools, that aims to be a simpler, more approachable complement to traditional man pages ([Upstream Source](https://github.com/tldr-pages/tldr) ⭐ 63,717 | 🐛 301 | 🌐 Markdown | 📅 2026-09-22 | [Dendron Vault Source](https://github.com/kevinslin/seed-tldr) ⭐ 6 | 🐛 2 | 🌐 CoffeeScript | 📅 2024-12-19).
...
* [Bassman/dendron-schemas](https://github.com/Bassmann/Dendron-schemas) ⭐ 32 | 🐛 0 | 📅 2024-06-09 - Collection of Dendron schema and template files.
* [IntegerMan/LearningLog](https://github.com/IntegerMan/LearningLog) ⭐ 10 | 🐛 17 | 🌐 TypeScript | 📅 2023-03-07 - A collection of highlights of things [Matt Eland](https://matteland.dev/) learned from reading, conferences, and courses as well as lists of resources to investigate.

## Dendron Official VS Code / VSCodium Extensions

> Official extensions by Dendron.

* [Dendron Snippet Maker](https://marketplace.visualstudio.com/items?itemName=dendron.dendron-snippet-maker) - Easily create markdown snippets using this fork of [Easy Snippet Maker](https://github.com/tariky/easy-snippet-maker) ⭐ 11 | 🐛 10 | 🌐 JavaScript | 📅 2020-09-09 (supports Dendron-specific features).
...
* [Path AutoComplete](https://github.com/ionutvmi/path-autocomplete) ⭐ 167 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-03 - Path autocomplete for Visual Studio Code.
...
* [`dendron-citations`](https://github.com/mivanit/dendron-citations) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2022-03-26 - A tool for converting BibTeX citations to notes, to use them in Dendron.
* [`dendron-pandoc`](https://github.com/mivanit/dendron-pandoc) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2022-01-10 - Run specialized [pandoc](https://pandoc.org/) filters for making Dendron links work properly, a script for adding bibliography information (or other data) to all markdown files in a vault, and more.
* [Export and Publish Draw.io Diagrams](https://github.com/LukeCarrier/dendron-publish-drawio) ⚠️ Archived - Use this tool to embed [draw.io / diagrams.net](https://www.diagrams.net/) diagrams in your published Dendron notes and documentation.
* [`gibcite`](https://github.com/Maarrk/gibcite) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2022-10-21 - A small command line tool for getting details of a paper from local [Zotero](https://www.zotero.org/) database (regardless if Zotero is running in the background).

### Migration tools

> Scripts, tools, and repos dedicated to migrating content from other platforms.

* [Yarle](https://github.com/akosbalasko/yarle) ⭐ 1,807 | 🐛 85 | 🌐 TypeScript | 📅 2026-03-31 - Yarle is the ultimate converter of **Evernote** notes to Markdown.
* [OneNote / Office 2016 Markdown Exporter](https://github.com/alxnbl/onenote-md-exporter) ⭐ 1,640 | 🐛 25 | 🌐 C# | 📅 2025-12-15 - OneNote Md Exporter is a console application running on Windows that exports your **OneNote 2016** notebooks in different markdown formats.
...
* [MarkDownload - Markdown Web Clipper](https://github.com/deathau/markdownload) ⭐ 4,023 | 🐛 216 | 🌐 JavaScript | 📅 2025-06-11 - This extension works like a web clipper, but it downloads articles in markdown format. Works on: `Chrome/Chromium` / `Firefox` / `Edge` / `Safari`.
...
* [The Book of Secret Knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) ⭐ 245,339 | 🐛 171 | 📅 2024-11-19 - A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools, and more.
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,898 | 🐛 24 | 📅 2026-09-02 - Delightful Node.js packages and resources.
* [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,217 | 🐛 49 | 📅 2024-04-15 - A collection of cool hidden and not so hidden features of Git and GitHub.
* [Awesome Shell](https://github.com/alebcay/awesome-shell) ⭐ 37,660 | 🐛 187 | 📅 2025-08-28 - A curated list of awesome command-line frameworks, toolkits, guides and gizmos.
  * [Modern Unix](https://github.com/ibraheemdev/modern-unix) ⭐ 33,027 | 🐛 69 | 📅 2024-09-10 - A collection of modern/faster/saner alternatives to common unix commands.
* [Awesome VS Code](https://github.com/viatsko/awesome-vscode) ⭐ 29,064 | 🐛 64 | 🌐 JavaScript | 📅 2026-06-21 - A curated list of delightful Visual Studio Code packages and resources.
* [Awesome GitHub Actions](https://github.com/sdras/awesome-actions) ⭐ 28,248 | 🐛 315 | 📅 2024-09-01 - A curated list of awesome things related to GitHub Actions.
* [Awesome Electron](https://github.com/sindresorhus/awesome-electron) ⭐ 27,291 | 🐛 7 | 📅 2026-05-03 - Useful resources for creating apps with Electron.
...
* [Digital Gardeners](https://github.com/MaggieAppleton/digital-gardeners) ⭐ 4,806 | 🐛 31 | 🌐 JavaScript | 📅 2024-06-22 - This collection of apps, tools and articles is here to help you learn more about digital gardening.
* [Awesome git](https://github.com/dictcp/awesome-git) ⭐ 2,946 | 🐛 84 | 📅 2026-07-07 - A curated list of amazingly awesome Git tools, resources and shiny things.
* [Second Brain](https://github.com/KasperZutterman/Second-Brain) ⭐ 1,844 | 🐛 1 | 📅 2026-09-16 - A curated list of awesome Public Zettelkastens / Second Brains / Digital Gardens.
