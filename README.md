...
* [TLDR](https://tldr.dendron.so/) - A Dendron vault of the [tldr-pages project](https://tldr.sh/): a collection of community-maintained help pages for command-line tools, that aims to be a simpler, more approachable complement to traditional man pages ([Upstream Source](https://github.com/tldr-pages/tldr) ⭐ 63,497 | 🐛 289 | 🌐 Markdown | 📅 2026-08-27 | [Dendron Vault Source](https://github.com/kevinslin/seed-tldr) ⭐ 6 | 🐛 2 | 🌐 CoffeeScript | 📅 2024-12-19).
...
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,625 | 🐛 26 | 📅 2026-05-03 - Delightful Node.js packages and resources.
* [GitHub Cheat Sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,731 | 🐛 48 | 📅 2024-04-15 - A collection of cool hidden and not so hidden features of Git and GitHub.
* [Awesome Shell](https://github.com/alebcay/awesome-shell) ⭐ 37,514 | 🐛 184 | 📅 2025-08-28 - A curated list of awesome command-line frameworks, toolkits, guides and gizmos.
  * [Modern Unix](https://github.com/ibraheemdev/modern-unix) ⭐ 33,022 | 🐛 69 | 📅 2024-09-10 - A collection of modern/faster/saner alternatives to common unix commands.
* [Awesome VS Code](https://github.com/viatsko/awesome-vscode) ⭐ 28,972 | 🐛 51 | 🌐 JavaScript | 📅 2026-06-21 - A curated list of delightful Visual Studio Code packages and resources.
* [Awesome GitHub Actions](https://github.com/sdras/awesome-actions) ⭐ 28,163 | 🐛 274 | 📅 2024-09-01 - A curated list of awesome things related to GitHub Actions.
